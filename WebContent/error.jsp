...
<!-- /font files -->
<!-- css files -->
<link href="${pageContext.request.contextPath }/templates/error/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- /css files -->
<!-- js files -->
...
<div class="container demo-2">
	<div class="content">
        <div id="large-header" class="large-header">
			<h1 class="header-w3ls">Trang không tồn tại</h1>
			<p class="w3-agileits1">Oops!</p>
            <canvas id="demo-canvas"></canvas>
			<img src="${pageContext.request.contextPath }/templates/error/images/owl.gif" alt="flashy" class="w3l">
...
<!-- js files -->
<script src="${pageContext.request.contextPath }/templates/error/js/rAF.js"></script>
<script src="${pageContext.request.contextPath }/templates/error/js/demo-2.js"></script>
<!-- /js files -->
</body>
</html>