<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- charts -->
<script src="${pageContext.request.contextPath }/templates/admin/js/raphael-min.js"></script>
<script src="${pageContext.request.contextPath }/templates/admin/js/morris.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath }/templates/admin/css/morris.css">
<script src="${pageContext.request.contextPath }/templates/admin/js/skycons.js"></script>
