...
<div id="container">
	<div class="pathway">
		<ul>
			...
			<li>Tác giả: ${objAuthor.name }</li>
		</ul>
	</div>
</div>
<div class="clear"></div>
<div id="container">
	<c:set value="/tac-gia/${slugUtil.makeSlug(objAuthor.name)}/${objAuthor.aid}" var="link"></c:set>
		...
		<div class="block" id="module_listfieldproducts">
			...
			<script type="text/javascript">
				function setOrder(ojb) {
					order = ojb.value;
					url = '${pageContext.request.contextPath}/tac-gia/${slugUtil.makeSlug(objAuthor.name)}/${objAuthor.aid}/page/${current_page}/ordering/'+ order;
