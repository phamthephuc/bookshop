...
<ul class="pagenav">
	<%
		if (current_page != 1) {
	%>
	<li><a href="${pageContext.request.contextPath }${link}/page/1">First</a></li>
	<li <%=previousPage%>><a
		href="${pageContext.request.contextPath }${link}<%=prelink%>"
		rel="previous">«</a></li>
	<%
		}
			if (sumPages == 2) {
	...
	<li <%out.print((current_page == 1) ? "class='active'" : "");%>><a
		href="${pageContext.request.contextPath }${link}/page/1">1</a></li>
	<li <%out.print((current_page == 2) ? "class='active'" : "");%>><a
		href="${pageContext.request.contextPath }${link}/page/2">2</a></li>
	<%
		}
			String activepage1 = "";
			if (sumPages >= 3) {
	...
	<li <%out.print(activepage1);%>><a
		href="${pageContext.request.contextPath }${link}/page/<%=i%>"><span><%=i%></span></a></li>
	<%
		}
	...
	<li><a
		href="<%=request.getContextPath()%>${link}/page/<%=sumPages%>">Last</a></li>
	<%
		}
	%>
