...
<div id="container">
        <div id="layoutGroup1">
            <div class="orderthanhs">
                <div class="title">Cám ơn bạn đã đặt hàng tại nobita.vn!</div>
...
<p>
	Nếu là khách hàng mới Greenbooks sẽ tiến hành xác nhận đơn hàng qua điện thoại để xác nhận thông tin bạn đã cung cấp trong đơn hàng. Sau khi đồng ý nobita sẽ tiến hành xử lý đơn hàng.</p>
<p>
	Sau lần mua hàng đầu tiên thành công, các đơn hàng tiếp theo sẽ được xác nhận bằng tin nhắn, hoặc Bạn cũng có thể xác nhận bằng cách bấm vào đường link mà hệ thống của Greenbooks gửi về trong email mà bạn đã đăng kí tài khoản tại Greenbooks.</p>
</div></div>
                <p class="clear"></p>
                <div class="fleft">
